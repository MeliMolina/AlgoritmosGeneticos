...
public class Poblacion {
    ...
    // Obtiene las actividades del  mejor individuo
    public LinkedList<Actividad> obtenerActividadesDeFittest()
    {
        Individuo fittest = obtenerFittest();
        return FuncionDeFitness.obtenerActividades(fittest);
